    ...
    <SmoothScroll>
      <main className="min-h-screen bg-background text-foreground">
        ...
        <section id="contact" className="relative py-20 sm:py-32">
          ...
          <div className="container-custom relative">
            <div className="flex items-center justify-center gap-3 mb-5 sm:mb-6">
              ...
              <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.3em] sm:tracking-[0.35em] text-gold-300">Let&apos;s talk</span>
              <span className="h-px w-8 sm:w-10 bg-gold-400/40" />
            </div>

            <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-5 sm:mb-6 text-center gold-gradient-text">
              {dict.cta.headline}
            </h2>
            <p className="text-neutral-400 mb-10 sm:mb-14 max-w-xl mx-auto text-center text-base sm:text-lg">
              {dict.cta.subtext}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
              ...
              <a
                ...
                className="group relative rounded-2xl border border-gold-400/20 bg-ink-900/60 p-6 sm:p-8
            ...
            {/* Primary CTA */}
            <div className="flex justify-center mt-10 sm:mt-14 px-2">
              <a
                href="mailto:nonxdev@gmail.com"
                className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-9 py-4 rounded-full font-semibold text-sm tracking-wide
        ...
        <footer className="relative border-t border-gold-400/10">
          <div className="container-custom py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-5 text-sm text-neutral-500 text-center md:text-left">
            <div className="flex flex-wrap items-baseline justify-center md:justify-start gap-x-1 gap-y-1 font-display">
              <span className="text-neutral-300">nonx</span>
              <span className="gold-gradient-text font-bold">dev</span>
              <span className="ml-1 sm:ml-3 text-neutral-600 text-xs sm:text-sm">— {dict.footer}</span>
            </div>
            <div className="flex items-center gap-5 sm:gap-6 text-xs uppercase tracking-[0.2em] text-neutral-500">
